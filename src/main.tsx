...
function App() {
  ...
  return (
    <div className="app">
      <h1 className="title">Table with custom tooltip</h1>
      <p className="description">
        This shows a table that uses a custom tooltip in the 'Age' and 'Profile
        Progress' columns.
      </p>
      <Table>
        <TableHeader>
                    ...
                    return (
                      <CellBasic
                        ...
                        tooltipProps={{
                          ...
                          leaveTouchDelay: 0,
                          leaveDelay: 0,
                          subtitle: cell.row.original.birthdate
                        }}
                      ></CellBasic>
                    );
                  case "progress":
